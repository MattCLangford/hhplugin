...
```text
https://mattclangford.github.io/hhplugin/0-loader.js?v=2.9;
```
...
| 2 | `1-docprev.js` | `1.7` | `lazy-supplying-list` | yes |
...
| 15 | `15-supplyingcommercial.js` | `0.8` | `lazy-supplying-list-proposal-creation` | yes |
