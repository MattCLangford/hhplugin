...
```text
https://mattclangford.github.io/hhplugin/0-loader.js?v=3.9;
```
...
| --- | --- | --- | --- | --- |
| 1 | `5-hirehop.js` | `1.1` | `lazy-shared-module` | yes |
| 2 | `1-docprev.js` | `2.2` | `lazy-supplying-list` | yes |
...
| 15 | `15-supplyingcommercial.js` | `1.5` | `lazy-supplying-list-proposal-creation` | yes |
