...
```text
https://mattclangford.github.io/hhplugin/0-loader.js?v=5.4;
```
...
| 2 | `1-docprev.js` | `2.4` | `lazy-supplying-list` | yes |
...
| 15 | `15-supplyingcommercial.js` | `2.7` | `lazy-supplying-list-proposal-creation` | yes |
