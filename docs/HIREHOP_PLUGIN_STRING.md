...
```text
https://mattclangford.github.io/hhplugin/0-loader.js?v=2.6;
```
...
| 2 | `1-docprev.js` | `1.5` | `lazy-supplying-list` | yes |
...
| 15 | `15-supplyingcommercial.js` | `0.6` | `lazy-supplying-list-proposal-creation` | yes |
