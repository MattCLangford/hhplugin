...
```text
https://mattclangford.github.io/hhplugin/0-loader.js?v=4.8;
```
...
| --- | --- | --- | --- | --- |
| 1 | `5-hirehop.js` | `1.2` | `lazy-shared-module` | yes |
| 2 | `1-docprev.js` | `2.3` | `lazy-supplying-list` | yes |
...
| 8 | `8-stagedesigner.js` | `2.3` | `lazy-supplying-list` | yes |
...
| 15 | `15-supplyingcommercial.js` | `2.3` | `lazy-supplying-list-proposal-creation` | yes |
