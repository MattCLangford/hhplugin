...
```text
https://mattclangford.github.io/hhplugin/0-loader.js?v=3.1;
```
...
| 2 | `1-docprev.js` | `1.8` | `lazy-supplying-list` | yes |
...
| 15 | `15-supplyingcommercial.js` | `0.9` | `lazy-supplying-list-proposal-creation` | yes |
